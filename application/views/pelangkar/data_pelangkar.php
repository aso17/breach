            ...
            foreach ($pelangkar as $kar) { ?>
              <tr>
                ...
                <td class="text-center">
                  <a class="text-center"><?php echo anchor('pelangkar/detail/' . $kar->id_pelangkar, '<span class="btn btn-warning btn-sm" style="margin-bottom: 5px;"><i class="fas fa-search-plus"></i></div>') ?></a>

                  <?php if ($this->session->userdata('level') == 2) : ?>
                    <a class="text-center"><?php echo anchor('pelangkar/edit/' . $kar->id_pelangkar, '<div class="btn btn-success btn-sm" style="margin-bottom: 5px;"><i class="fas fa-edit"></i></div>') ?></a>
                    <a onclick="deleteConfirm('<?= base_url('pelangkar/delete/' . $kar->id_pelangkar) ?>')" href="#!" style="margin-bottom: 5px;" class="btn btn-danger btn-sm btn-icon-split" data-toggle="tooltip" data-placement="top" title="Delete">
