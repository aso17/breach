                      ...
                      <tr>
                          ...
                          <td class="text-center" width="100px">
                              <a class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                  data-target="#modal-detail<?= $kar->id_pelangkar ?>"><span>
                                      <i class="fas fa-eye"></i>
                                  </span>
                                  <span class="font-weight-bold">Lihat</span></a>
                              <!-- Modal Image -->
                              <div class="modal fade" id="modal-detail<?= $kar->id_pelangkar ?>" tabindex="-1"
                                  aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-body">
                                              <img src="<?php echo base_url() . './assets/bukti/' . $kar->bukti ?>"
                                                  class="img-thumbnail">
                                          </div>
                                      </div>
                                  </div>
