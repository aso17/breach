                        ...
                        <form method="post" action="">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="no_visit">Nomer Visitor</label>
                                    <input type="text"
                                        class="form-control <?php echo form_error('no_visit') ? 'is-invalid' : '' ?>"
                                        id="no_visit" name="no_visit">
                                    <div class="invalid-feedback">
                                        <?php echo form_error('no_visit') ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nama_visitor" name="nama_visitor">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="alamat" name="alamat" placeholder="nama alamat">
                                    <div class="invalid-feedback">
