            ...
            <form method="post" action="">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="hidden" value="<?= $kategori->id_kategori ?>" class="form-control" id="id_kategori" name="id_kategori">
                  <input type="text" value="<?= $this->input->post('kategori') ? $this->input->post('kategori') : $kategori->kategori ?>" class="form-control <?php echo form_error('kategori') ? 'is-invalid' : '' ?>" id="kategori" name="kategori">
