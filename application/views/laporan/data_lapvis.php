<div class="card shadow mb-4">
    <div class="container">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <br>
                                    <input type="datetime-local" class="form-control <?php echo form_error('tanggalawal') ? 'is-invalid' : '' ?>" id="tanggalawal" name="tanggalawal" placeholder="tanggal awal">
                            ...
                            <td>
                                <div class="form-group">
                                    <br>
                                    <input type="datetime-local" class="form-control <?php echo form_error('tanggalakhir') ? 'is-invalid' : '' ?>" id="tanggalakhir" name="tanggalakhir" placeholder="tanggal akhir">
                                    <div class="invalid-feedback">
        ...
        if ($datafilter != NULL) { ?>
            <div class="panel">
                <div class="panel-heading">
                    <h5>Data laporan pelanggaran dari <b><?= date('d/m/Y', strtotime($tanggalawal)); ?></b> sampai
                        <b><?= date('d/m/Y', strtotime($tanggalakhir)); ?><b></b>
                    </h5>
                </div>
                <br>
                <div class="panel-body">
                    <a href="<?php echo base_url('cetak_lapvis/mypdf/') . $tanggalawal . "/" . $tanggalakhir ?>" class="btn btn-warning btn-icon-split btn-sm" target="_BLANK" style="margin-bottom: 5px;">
