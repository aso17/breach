            ...
            <form method="post" action="">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?php echo form_error('nik') ? 'is-invalid' : '' ?>" id="nik" name="nik">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?php echo form_error('nama_lengkap') ? 'is-invalid' : '' ?>" id="nama_lengkap" name="nama_lengkap">
                  <div class="invalid-feedback">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select id="level" class="form-control <?php echo form_error('level') ? 'is-invalid' : '' ?>" id="level" name="level">
                    <option hidden value="" selected>Pilih Level</option>
                    <option value="1"> Admin </option>
                    <option value="2"> Security </option>
                    <option value="3"> IRGA </option>
                  </select>
                  <div class="invalid-feedback">
