                        ...
                        <form method="post" action="">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="<?= $karyawan->nama_lengkap ?>" class="form-control"
                                        id="nama_lengkap" name="nama_lengkap">
                                    <input type="text"
                                        value="<?= $this->input->post('nama_lengkap') ? $this->input->post('nama_lengkap') : $karyawan->nama_lengkap ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="<?= $this->input->post('departemen') ? $this->input->post('departemen') : $karyawan->departemen ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_posisi" id="id_posisi"
                                        ...
                                        <option value="<?= $dt->id_posisi ?>"
                                            <?= set_value('id_posisi') == "<?= $dt->level ?>" ? "selected" : '' ?>
                                            ><?= $dt->level ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="<?= $this->input->post('j_kelamin') ? $this->input->post('j_kelamin') : $karyawan->j_kelamin ?>"
                                        class="form-control <?php echo form_error('j_kelamin') ? 'is-invalid' : '' ?>"
                                        id="j_kelamin" name="j_kelamin">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="<?= $this->input->post('email') ? $this->input->post('email') : $karyawan->email ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="<?= $this->input->post('telp') ? $this->input->post('telp') : $karyawan->telp ?>"
