                        ...
                        <form method="post" action="">
                            <div class="card-body">
                                <div class="form-group">
                                    <input type="hidden" value="<?= $karyawan->nik_karyawan ?>" class="form-control" id="nik" name="nik">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_posisi" id="id_posisi" class="form-control custom-form <?= form_error('id_posisi') ? 'is-invalid' : '' ?>" name="id_posisi">
                                        ...
                                        <?php foreach ($id_posisi as $dt) { ?>
                                            <option value="<?= $dt->id_posisi ?>" <?= set_value('id_posisi') == "<?= $dt->level ?>" ? "selected" : '' ?>><?= $dt->level ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="j_kelamin" value="<?= $this->input->post('j_kelamin') ? $this->input->post('j_kelamin') : $karyawan->j_kelamin ?>" class="form-control <?php echo form_error('j_kelamin') ? 'is-invalid' : '' ?>" id="j_kelamin" name="j_kelamin">
