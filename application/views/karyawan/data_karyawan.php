                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a
                                class="text-center"><?php echo anchor('karyawan/edit/' . $kar->nik_karyawan, '<div class="btn btn-success btn-sm" style="margin-bottom: 5px;"><i class="fas fa-edit"></i></div>') ?></a>
                            <a onclick="deleteConfirm('<?= base_url('karyawan/delete/'  .  $kar->nik_karyawan) ?>')"
